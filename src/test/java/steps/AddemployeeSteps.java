...
public class AddemployeeSteps extends CommonMethods {
    ...
    public void user_enters_firstname_middlename_and_lastname() {
        ...
        sendText(add.firstName, ("khadija"));
        sendText(add.middleName, ("Habibi"));
        sendText(add.lastName, ("rasikh"));
    }
    ...
    @Given("user enters {string} {string} and {string} in the application")
    ...
    public void employee_added_successfully() {
        System.out.println("employee successfully add");
    }
